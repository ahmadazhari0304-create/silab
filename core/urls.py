...
urlpatterns = [
    ...
    path('api/sop-categories', views.handle_sop_categories, name='handle_sop_categories'),
    path('api/sop-categories/<int:category_id>', views.handle_sop_categories, name='handle_sop_categories_delete'),
